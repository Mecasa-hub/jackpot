---
description: How the JACPOT treasury operates, generates yield, and sustains the ecosystem
---
...
The JACPOT Treasury is the financial backbone of the protocol. It serves three critical functions:
...
| --- | --- | --- |
| **USDC** | 5% of jackpot distribution + raffle pass revenue overflow | Primary yield-generating asset |
| **JACPOT** | 15% of total supply (vested) | Protocol-owned tokens for strategic use |
...
| **Drought Bonuses** | 20% | Jackpot top-ups during low volume |
...
- A **Treasury Dashboard** on the JACPOT website shows:
...
```
Trading Volume → Tax Revenue → Jackpot Grows
                                    │
                              5% to Treasury
                                    │
                              Treasury Deploys
              ...
              Crate Rewards    Hype Vault    Drought Bonus
                    │               │               │
              User Engagement  New Users     Bigger Jackpot
                    │               │               │
                    └───────────────┼───────────────┘
                                    │
                              More Volume
