---
description: Important risks, disclaimers, and legal considerations
---
...
| --- | --- | --- |
| **Code bugs** | Undiscovered vulnerabilities in smart contracts | Multiple independent audits, bug bounty program |
| **Logic errors** | Flaws in game theory or economic design | Extensive testing, economic modeling, testnet beta |
| **Composability risk** | Interactions with external contracts (DEX, Chainlink) | Minimal external dependencies, battle-tested integrations |
| **Immutability** | Bugs in non-upgradeable contracts cannot be fixed | Thorough auditing before deployment, emergency pause |

> **Despite audits and testing, no smart contract can be guaranteed 100% secure. Only participate with funds you can afford to lose.**
...
| Risk | Description | Mitigation |
| --- | --- | --- |
| **DeFi protocol exploit** | Protocols where treasury is deployed could be hacked | Diversified deployment, blue-chip protocols only |
| **Yield compression** | DeFi yields may decrease over time | Diversified strategy, RWA exposure |
| **Smart contract risk (external)** | External DeFi contracts may have vulnerabilities | Only battle-tested protocols, continuous monitoring |

### 5. Regulatory Risk

| Risk | Description |
| --- | --- |
| **Securities classification** | Regulatory bodies may classify aspects of the protocol as securities |
| **Gambling classification** | Raffle mechanics may be classified as gambling in some jurisdictions |
...
| Risk | Description |
| --- | --- |
| **Team risk** | The team may be unable to continue development |
| **Chainlink dependency** | VRF downtime would delay draws (not lose funds) |
| **Network congestion** | High gas fees on Base could impact user experience |
| **Frontend risk** | dApp frontend could experience downtime (contracts remain accessible) |

### 7. Market Risk

| Risk | Description |
| --- | --- |
| **Bear market** | Prolonged market downturns reduce trading volume and engagement |
| **Competition** | Similar protocols may launch with improved mechanics |
| **Narrative shift** | Market attention may move away from gamified DeFi |
...
3. You understand that past performance does not guarantee future results
4. You accept full responsibility for your participation
5. You have verified that participation is legal in your jurisdiction
